...
<div class="main-wrapper">
    <!-- Sidebar -->
    @include('partials.sidebar-ia-ypta')
    <!-- End of Sidebar -->
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
                            ...
                            <div class="row align-items-start">
                                <div class="col-md-7">
                                    <p class="text-muted tx-13 mb-3 mb-md-0">
                                        ...
                                        usually from the sale of goods and
                                        services to customers.
                                    </p>
                                </div>
                                <div
                                    class="col-md-5 d-flex justify-content-md-end"
                                >
                                    <div
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted">
                                ...
                                number of goods or services sold in a given time
                                period.
                            </p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-6 d-flex justify-content-end">
                                    <div>
                                        <label
                                            class="d-flex align-items-center justify-content-end tx-10 text-uppercase fw-bolder"
                                            >Total storage
                                            <span
                                                class="p-1 ms-1 rounded-circle bg-secondary"
                                            ></span
                                        ></label>
                                ...
                                <div class="col-6">
                                    <div>
                                        <label
                                            class="d-flex align-items-center tx-10 text-uppercase fw-bolder"
                                            ><span
                                                class="p-1 me-1 rounded-circle bg-primary"
                                            ></span>
                                            Used storage</label
                                        >
            ...
            <div class="row">
                <div
                    class="col-lg-5 col-xl-4 grid-margin grid-margin-xl-0 stretch-card"
                >
                    <div class="card">
                        <div class="card-body">
                            <div
