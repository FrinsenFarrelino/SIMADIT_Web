...
>
    ...
    <div class="col-12 col-xl-12 stretch-card">
        <div class="row flex-grow-1">
            <div class="col-md-12 grid-margin">
                <input type="checkbox" class="btn-check" id="EDM01" checked/>
                ...
                <input type="checkbox" class="btn-check" id="temuan" checked/>
                <label class="btn btn-outline-primary" for="temuan"
                    >Temuan</label
                >
                <input type="checkbox" class="btn-check" id="nilai-auditee" checked/>
                <label class="btn btn-outline-primary" for="nilai-auditee"
                    >Nilai Auditee</label
                >
                <input type="checkbox" class="btn-check" id="jurnal" checked/>
