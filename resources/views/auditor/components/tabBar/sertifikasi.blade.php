...
>
    ...
    <div class="col-12 col-xl-12 stretch-card">
        <div class="row flex-grow-1">
            <div class="col-md-12 grid-margin">
                <input type="checkbox" class="btn-check" id="EDM01-sertifikasi" />
                <label class="btn btn-outline-primary" for="EDM01-sertifikasi">EDM01</label>
                <input type="checkbox" class="btn-check" id="EDM02-sertifikasi" />
                <label class="btn btn-outline-primary" for="EDM02-sertifikasi">EDM02</label>
                <input type="checkbox" class="btn-check" id="APO01-sertifikasi" />
                <label class="btn btn-outline-primary" for="APO01-sertifikasi">APO01</label>

                <input type="checkbox" class="btn-check" id="BAI03-sertifikasi" />
                <label class="btn btn-outline-primary" for="BAI03-sertifikasi">BAI03</label>
                <input type="checkbox" class="btn-check" id="temuan-sertifikasi" />
                <label class="btn btn-outline-primary" for="temuan-sertifikasi"
                    >Temuan</label
                >
                <input type="checkbox" class="btn-check" id="nilai-auditee-sertifikasi" />
                <label class="btn btn-outline-primary" for="nilai-auditee-sertifikasi"
                    >Nilai Auditee</label
                >
                <input type="checkbox" class="btn-check" id="jurnal-sertifikasi" />
                <label class="btn btn-outline-primary" for="jurnal-sertifikasi"
                    >Jurnal</label
                >
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-row-reverse bd-highlight">
                                <div
                                    ...
                                    id="submit-bukti-dokumen-sertifikasi"
                                >
                                    Tambah Dokumen
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-row-reverse bd-highlight">
                                <div
                                    class="btn btn-primary mt-3"
                                    id="submit-bukti-dokumen2-sertifikasi"
                                >
                                    Tambah Dokumen
                                </div>
                            </div>
    ...
    <!-- CHECKBOX TEMUAN -->
    <div class="col-12 col-xl-12 stretch-card" id="isi-temuan-sertifikasi">
        <div class="row flex-grow-1">
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row-reverse bd-highlight">
                            <div
                                ...
                                data-bs-target="#add-temuan-sertifikasi"
                            >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                ...
                                                data-bs-toggle="modal"
                                                data-bs-target="#detail-temuan-sertifikasi"
                                            >
                                                <i
                                                    data-feather="eye"
                                                    class="feather-16"
...
Kepala bagian keuangan memberikan uang muka berdasarkan formulir permintaan uang muka yang sudah diotorisasi oleh marketing sales supervisor. Otorisasi dari supervisor biasanya diberikan dengan mudah tanpa memperhatikan batas maksimum yang bisa diberikan.</textarea
                                            ...
                                            <div
                                                ...
                                                data-bs-toggle="modal"
                                                data-bs-target="#ubah-temuan-sertifikasi"
                                            >
                                                <i
                                                    data-feather="edit"
                                                    class="feather-16"
...
Kepala bagian keuangan memberikan uang muka berdasarkan formulir permintaan uang muka yang sudah diotorisasi oleh marketing sales supervisor. Otorisasi dari supervisor biasanya diberikan dengan mudah tanpa memperhatikan batas maksimum yang bisa diberikan.</textarea
    ...
    <div class="col-12 col-xl-12 stretch-card" id="isi-nilai-auditee-sertifikasi">
        <div class="row flex-grow-1">
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
    ...
    <!-- CHECKBOX-JURNAL -->
    <div class="col-12 col-xl-12 stretch-card" id="isi-jurnal-sertifikasi">
        <div class="row flex-grow-1">
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
