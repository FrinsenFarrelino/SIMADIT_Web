...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="mb-4">
                <h4 class="mb-3 mb-md-0 fs-2">DETAIL TAHAP</h4>
            </div>

            <div class="row">
                <div style="overflow-x: auto">
                    <div
                        class="d-flex flex-nowrap justify-content-center mb-4 text-white fw-bold"
                    >
                        <div
                            class="d-flex flex-column align-items-center text-success mx-3"
                            style="width: 125px"
                        >
                            <button
                                class="rounded-circle border border-5 border-success bg-white d-flex justify-content-center align-items-center mb-3 step1"
                                value="1"
                                style="height: 100px; width: 100px"
                            >
                                <span class="fw-bold fs-3 text-success">1</span>
                            </button>
                            <div class="d-flex flex-column align-items-center">
                                <div>Tahap 1 :</div>
                                <div class="text-center">
                                    Informasi Objek Audit
                                </div>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            <button
                                class="rounded-circle border border-5 border-success bg-success d-flex justify-content-center align-items-center mb-3 step2"
                                value="2"
                                style="height: 100px; width: 100px"
                            >
                                <span class="fw-bold fs-3 text-white">2</span>
                            </button>
                            <div class="d-flex flex-column align-items-center">
                                <div>Tahap 2 :</div>
                                <div class="text-center">
                        ...
                        >
                            <button
                                class="rounded-circle border border-5 border-success bg-success d-flex justify-content-center align-items-center mb-3 step3"
                                value="3"
                                style="height: 100px; width: 100px"
                            >
                                <span class="fw-bold fs-3 text-white">3</span>
                            </button>
                            <div class="d-flex flex-column align-items-center">
                                <div>Tahap 3 :</div>
                                <div class="text-center">
                        ...
                        >
                            <button
                                class="rounded-circle border border-5 border-success bg-success d-flex justify-content-center align-items-center mb-3 step4"
                                value="4"
                                style="height: 100px; width: 100px"
                            >
                                <span class="fw-bold fs-3 text-white">4</span>
                            </button>
                            <div class="d-flex flex-column align-items-center">
                                <div>Tahap 4 :</div>
                                <div class="text-center">
                        ...
                        >
                            <button
                                class="rounded-circle border border-5 border-success bg-success d-flex justify-content-center align-items-center mb-3 step5"
                                value="5"
                                style="height: 100px; width: 100px"
                            >
                                <span class="fw-bold fs-3 text-white">5</span>
                            </button>
                            <div class="d-flex flex-column align-items-center">
                                <div>Tahap 5 :</div>
                                <div class="text-center">
                        ...
                        >
                            <button
                                class="rounded-circle border border-5 border-success bg-success d-flex justify-content-center align-items-center mb-3 step6"
                                value="6"
                                style="height: 100px; width: 100px"
                            >
                                <span class="fw-bold fs-3 text-white">6</span>
                            </button>
                            <div class="d-flex flex-column align-items-center">
                                <div>Tahap 6 :</div>
                        ...
                        >
                            <button
                                class="rounded-circle border border-5 border-success bg-success d-flex justify-content-center align-items-center mb-3 step7"
                                value="7"
                                style="height: 100px; width: 100px"
                            >
                                <span class="fw-bold fs-3 text-white">7</span>
                            </button>
                            <div class="d-flex flex-column align-items-center">
                                <div>Tahap 7 :</div>
                                <div class="text-center">Laporan Audit</div>
                            </div>
                        </div>
                    </div>
                </div>
...
Setelah merekrut orang yang tepat, manajer SDM akan melatih dan memotivasi karyawannya agar dapat bekerja secara optimal di lingkungan kerja yang kondusif. Motivasi sangatlah penting bagi seorang manajer, karena dalam bisnis kita tidak bisa menyalahkan kurangnya tenaga kerja, yang ada hanyalah kurangnya semangat.
        ...
        <script>
            ...
            $(".step1, .step2, .step3, .step4, .step5, .step6, .step7").click(
                function () {
                    $("#tampil-tahap").removeClass("d-none");
                    currentState = "Tahap " + $(this).text();
